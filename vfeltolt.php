...
<link rel="stylesheet" type="text/css" href="_css/feltolt2.css">
<style>
</style>
</head>
<body>
...
<a style="color: white; text-decoration: none; cursor:pointer;  display: block;" href="regisztralj.php"><?php echo $row["pdf_name"]; ?></a>                                 
</div>
  <?php
		}
	}
